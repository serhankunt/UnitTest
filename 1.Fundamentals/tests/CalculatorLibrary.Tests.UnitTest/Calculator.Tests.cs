...
public class CalculatorTest : IDisposable , IAsyncLifetime
{
    ...
    public CalculatorTest(ITestOutputHelper outputHelper)
    {
        ...
        //Constructor asenkron çalýþtýrmaz. Baþlangýçta asenkron yapý kullanmak istiyorsan InitializeAsync kullanacaksýn.
    }
    [Fact]
    ...
    public void Subtract_ShouldSubtractTwoNumbers_WhenTwoNumbersAreInteger()
    {
        ...
        //FluentAssertion kütüphanesi ile bu iþlemler yapýlýyor.
        result.Should().Be(8);
        result.Should().NotBe(7);
    }
    ...
    [InlineData(6,2,3)]
    [InlineData(18,2,9)]
    [InlineData(0,0,0,Skip ="0/0 iþlemi yapýlamaz")]
